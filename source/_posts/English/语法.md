...
常用的连接词包括：that，if，whether，who，whom，whose，which，what，how，when，where，why等。名词性从句中，**that没有实际意义**，也不作句子成分，它只是起连接作用，<em style="color:red">**在宾语从句中可以省略**</em>。而**其他连接词不仅起连接作用**，还作为句子的一部分，**不能省略**。
...
在名词性从句中,  只有宾语从句中的that可以省略,   **在定语从句中,  只有当that充当的成分是宾语的时候才能省略**
