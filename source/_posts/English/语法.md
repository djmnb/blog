...
在英语中，**名词性从句(Noun Clauses)就是在句子中起名词作用的从句**，可以做主语、宾语和表语。名词性从句通常由连词that，if，whether，或者连接代词what，who，which，连接副词when，where，how，why等引导。
...
如果是疑问句,那就更好办了, 比如  what did you buy yesterday? -> what  you bought yesterday   ->   I kown what  you bought yesterday 
...
* 宾语从句在英语中常见于以下三种位置：
  ...
  3. **某些结构后的宾语从句**：这类宾语从句位于某些特定结构后，如"It's (not) + adj + that..." 或 "It's (not) + n + that...". 例如：
      - "It's necessary that we arrive early."（我们早点到是必要的。）
...
1. **关系代词**：在定语从句中，关系代词有"who", "whom", "whose", "that", "which"。"Who" 和 "whom" 用于指人，"that" 和 "which" 用于指物，"whose" 用于指人或物。例如：The man who spoke yesterday is my professor (昨天讲话的那个人是我的教授)。

2. **关系副词**："when", "where" 和 "why" 也可以引导定语从句。"When"用于时间，"where" 用于地点，"why" 用于原因。例如：I'll never forget the day when I first met you (我永远不会忘记我第一次遇见你的那一天)。
...
介词提前的定语从句是指在定语从句中，**介词与其宾语一起提前放置在关系词之前的结构**。这种结构在英语中相对较常见，有以下几种形式：
...
5. **目的状语从句**：通常由so that, in order that等引导。例如："He got up early so that he could catch the train."

6. **结果状语从句**：通常由so...that, such...that等引导。例如："The rain was so heavy that we had to stay home."
...
在名词性从句中,  一般that只做连接词,可以省略,但是建议不要省略,   **在定语从句中,  只有当that充当的成分是宾语的时候才能省略**
