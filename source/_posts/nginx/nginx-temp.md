...
![详解 K8S 高可用部署，超详细！](../../img/nginx-tempassets/v2-02d7c11f3a7767a9215c9357e5974281_720w-167057733820627.jpg)
...
[![运维君莫笑](../../img/nginx-tempassets/v2-83cd98e2d04dd978344bacd025162416_l-167057733820629.jpg)](https://www.zhihu.com/people/xue-wu-zhi-jing-29-11)

[运维君莫笑](https://www.zhihu.com/people/xue-wu-zhi-jing-29-11)
...
官方文档：[https://kubernetes.io/zh-cn/docs/home/](https://link.zhihu.com/?target=https%3A//kubernetes.io/zh-cn/docs/home/)
...
```text
# 配置yum源
cd /etc/yum.repos.d ; mkdir bak; mv CentOS-Base.bak/
# centos7
...
![img](../../img/nginx-tempassets/v2-19bf4b3d0af1dccc2eb03e65fd0eb028_720w-167057733820631.webp)
...
![img](../../img/nginx-tempassets/v2-8d5b963ef40400860be9e43688b4af19_720w-167057733820633.webp)
...
![img](../../img/nginx-tempassets/v2-e707aaa5bebf17373f7e1fd8f6264768_720w-167057733820635.webp)
...
![img](../../img/nginx-tempassets/v2-70ce1816a72aa271645c98384229acf5_720w-167057733820637.webp)
...
![img](../../img/nginx-tempassets/v2-580a3af1365f5b44073d8b5b8e28f6ca_720w.webp)
...
![img](../../img/nginx-tempassets/v2-a462f0d144ac83342fcaa999caf68978_720w.webp)
...
> 链接：[https://pan.baidu.com/s/1HB9xuO3bssAW7v5HzpXkeQ](https://link.zhihu.com/?target=https%3A//pan.baidu.com/s/1HB9xuO3bssAW7v5HzpXkeQ)
> 提取码：8888

再查看 node 节点，就已经正常了

![img](../../img/nginx-tempassets/v2-e21f93794fc4024837113c9dae52e4fa_720w.webp)
...
![img](../../img/nginx-tempassets/v2-f028e5bc11ec9224d797885c72b9cf4f_720w.webp)
...
![img](../../img/nginx-tempassets/v2-3b2329bf7ae8e873dd5223f175c463a2_720w.webp)
...
![img](../../img/nginx-tempassets/v2-321cbc635af286fc69c4df6adeaeab06_720w.webp)
...
![img](../../img/nginx-tempassets/v2-0accb16aa976923d0713702ec6b90656_720w.webp)
...
![img](../../img/nginx-tempassets/v2-b289b519ac66dc979e0847d1d19c9144_720w.webp)

- 使用外部 etcd 节点，其中 etcd 在与控制平面不同的节点上运行，架构图如下：

![img](../../img/nginx-tempassets/v2-96c4e19c9bdb063b0ec538f9869e979e_720w.webp)
...
![img](../../img/nginx-tempassets/v2-843588abc69dabebf81e6f1961152597_720w.webp)
...
![img](../../img/nginx-tempassets/v2-b0b2aea628932f97b8232ee5bae4745c_720w.webp)
...
![img](../../img/nginx-tempassets/v2-354ab29c92737372e5062089e80559e5_720w.webp)
...
![img](../../img/nginx-tempassets/v2-e37a3d7bafcfd7a912f9e8fe2368d84e_720w.webp)
...
![img](../../img/nginx-tempassets/v2-e95e97b96e627cb7c60ead80a17e3388_720w.webp)
...
GitHub 地址：[https://github.com/kubernetes/dashboard](https://link.zhihu.com/?target=https%3A//github.com/kubernetes/dashboard)
...
![img](../../img/nginx-tempassets/v2-d1c1fa6c9f37bf83dfa19cba5225533d_720w.webp)
...
![img](../../img/nginx-tempassets/v2-603d574e08f5cbd8f6c5408a7bc4e24c_720w.webp)
...
登录：[https://cluster-endpoint:31443](https://link.zhihu.com/?target=https%3A//cluster-endpoint%3A31443)

![img](../../img/nginx-tempassets/v2-8bc3eceefb86dd2d911601494ea88e13_720w.webp)



输入上面创建的 token 登录

![img](../../img/nginx-tempassets/v2-3a21f63b00a4515fde57c7178ba63b53_720w.webp)



## **四、k8s 镜像仓库 harbor 环境部署**

GitHub 地址：[https://github.com/helm/helm/releases](https://link.zhihu.com/?target=https%3A//github.com/helm/helm/releases)
...
ingress 官方网站：[https://kubernetes.github.io/ingress-nginx/](https://link.zhihu.com/?target=https%3A//kubernetes.github.io/ingress-nginx/)
ingress 仓库地址：[https://github.com/kubernetes/ingress-nginx](https://link.zhihu.com/?target=https%3A//github.com/kubernetes/ingress-nginx)
部署文档：[https://kubernetes.github.io/ingress-nginx/deploy/](https://link.zhihu.com/?target=https%3A//kubernetes.github.io/ingress-nginx/deploy/)
...
![img](../../img/nginx-tempassets/v2-ae2a7c114d7d79c0265295c750a658a3_720w.webp)
...
> 【温馨提示】crontab 定时同步数据不太好，可以使用`rsync+inotify`做数据实时同步，这里篇幅有点长了，先不讲，如果后面有时间会出一篇单独文章来讲。

### **6）创建 nfs provisioner 和持久化存储 SC**

> 【温馨提示】这里跟我之前的文章有点不同，之前的方式也不适用新版本。

GitHub 地址：[https://github.com/kubernetes-sigs/nfs-subdir-external-provisioner](https://link.zhihu.com/?target=https%3A//github.com/kubernetes-sigs/nfs-subdir-external-provisioner)
...
> 【温馨提示】默认镜像是无法访问的，这里使用 dockerhub 搜索到的镜像`willdockerhub/nfs-subdir-external-provisioner:v4.0.2`，还有就是 StorageClass 不分命名空间，所有在所有命名空间下都可以使用。
...
![img](../../img/nginx-tempassets/v2-6828a1f091e60b5acd26919a0bf9da89_720w.webp)
...
![img](../../img/nginx-tempassets/v2-65560ac42ffeb5041ae399bef6160c5c_720w.webp)
...
![img](../../img/nginx-tempassets/v2-5b1261e498e4d25160be622a4c2e5ab8_720w.webp)

### **5、访问 harbor**

[https://myharbor.com](https://link.zhihu.com/?target=https%3A//myharbor.com)
账号/密码：admin/Harbor12345

![img](../../img/nginx-tempassets/v2-87e164a25b38f7e9480997a8d8140d0d_720w.webp)
...
![img](../../img/nginx-tempassets/v2-6255f3d8e5886c39ffe00fefc6837655_720w.webp)
...
![img](../../img/nginx-tempassets/v2-bacbc2bbef4eb6fbe322951acc9ba8a2_720w.webp)
...
![img](../../img/nginx-tempassets/v2-a28a8bfd2cf2417a281307061da2bb89_720w.webp)
...
![img](../../img/nginx-tempassets/v2-f1793a2c4a75f686acc94a6b2dda4017_720w.webp)
...
![img](../../img/nginx-tempassets/v2-1845e094a751e7a213cb2b9aae4cc193_720w.webp)
